...
describe('AskView message deep link', () => {
	...
	it('should restore and focus the linked answer without asking the question again', async () => {
	...
	it('should prioritize a message deep link over a mixed question query', async () => {
		const pinia = createPinia()
		setActivePinia(pinia)
		const router = createRouter({
			history: createMemoryHistory(),
