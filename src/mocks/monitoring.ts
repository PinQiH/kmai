...
export const logEntries: LogEntry[] = [
	{ id: 'log-01', timestamp: '10:42:18', level: 'error', service: 'document-worker', message: '文件處理失敗：解析器逾時（資訊安全教育訓練.pdf）', traceId: 'trc-9f13a2', fields: { documentId: 'doc-118', stage: 'parse', retries: '2' } },
	{ id: 'log-02', timestamp: '10:42:02', level: 'warn', service: 'llm-gateway', message: '推論請求逾時，改用備援模型重試', traceId: 'trc-9f1391', fields: { model: 'gpt-4.1-mini', timeoutMs: '8000', fallback: 'ollama-local' } },
	{ id: 'log-03', timestamp: '10:41:55', level: 'info', service: 'kmai-api', message: '問答完成：差旅住宿費用上限（2 筆引用）', traceId: 'trc-9f1386', fields: { userId: 'user-204', elapsedMs: '2410', citations: '2' } },
	{ id: 'log-04', timestamp: '10:41:31', level: 'warn', service: 'document-worker', message: '處理佇列長度 18 件，超過建議上限 15 件', traceId: 'trc-9f1372', fields: { queue: 'ingest', depth: '18' } },
	{ id: 'log-05', timestamp: '10:40:47', level: 'info', service: 'kmai-api', message: '登入成功：employee@company.com', traceId: 'trc-9f1360', fields: { ip: '10.20.1.18', method: 'password' } },
	{ id: 'log-06', timestamp: '10:39:12', level: 'error', service: 'llm-gateway', message: '模型服務回應 503，已將請求排入重試佇列', traceId: 'trc-9f1341', fields: { statusCode: '503', endpoint: '/v1/chat/completions' } },
	{ id: 'log-07', timestamp: '10:38:58', level: 'debug', service: 'vector-store', message: '相似度查詢完成，取回 20 筆候選片段', traceId: 'trc-9f1338', fields: { topK: '20', elapsedMs: '41' } },
	{ id: 'log-08', timestamp: '10:38:20', level: 'info', service: 'notification', message: '告警信已寄給 系統維運群組（3 位收件人）', traceId: 'trc-9f1329', fields: { rule: '文件處理積壓過高', recipients: '3' } },
	{ id: 'log-09', timestamp: '10:37:44', level: 'warn', service: 'kmai-api', message: '同一使用者 1 分鐘內送出 12 次提問，已套用速率限制', traceId: 'trc-9f1310', fields: { userId: 'user-77', limit: '10/min' } },
	{ id: 'log-10', timestamp: '10:36:02', level: 'info', service: 'document-worker', message: '文件向量化完成：採購請款標準作業流程.docx', traceId: 'trc-9f12f8', fields: { documentId: 'doc-004', chunks: '75' } },
	{ id: 'log-11', timestamp: '10:35:19', level: 'debug', service: 'kmai-api', message: '混合檢索權重：語意 0.6 / 關鍵字 0.4', traceId: 'trc-9f12e1', fields: { semantic: '0.6', keyword: '0.4' } },
	{ id: 'log-12', timestamp: '10:34:07', level: 'error', service: 'notification', message: 'SMTP 連線被拒，告警信改為稍後重送', traceId: 'trc-9f12c4', fields: { host: 'smtp.company.com', retryInMinutes: '5' } },
]
...
export const alertEvents: AlertEvent[] = [
	{ id: 'evt-01', ruleName: '文件處理積壓過高', severity: 'critical', status: 'firing', observed: '18 件（門檻 15 件）', startedAt: '今天 10:30', durationLabel: '持續 12 分鐘', notifiedCount: 1, notifyResult: '已寄出' },
	{ id: 'evt-02', ruleName: '回答延遲過高', severity: 'warning', status: 'firing', observed: '4.3 秒（門檻 4 秒）', startedAt: '今天 10:36', durationLabel: '持續 6 分鐘', notifiedCount: 3, notifyResult: '已寄出' },
	{ id: 'evt-03', ruleName: 'LLM 服務成功率下降', severity: 'warning', status: 'silenced', observed: '97.4%（門檻 98%）', startedAt: '今天 09:58', durationLabel: '靜音至 12:00', notifiedCount: 0, notifyResult: '未通知' },
	{ id: 'evt-04', ruleName: '請求錯誤率異常', severity: 'critical', status: 'resolved', observed: '3.6%（門檻 3%）', startedAt: '今天 08:12', durationLabel: '22 分鐘後恢復', notifiedCount: 4, notifyResult: '已寄出' },
	{ id: 'evt-05', ruleName: '文件處理積壓過高', severity: 'critical', status: 'resolved', observed: '16 件（門檻 15 件）', startedAt: '昨天 22:41', durationLabel: '35 分鐘後恢復', notifiedCount: 1, notifyResult: '寄送失敗' },
	{ id: 'evt-06', ruleName: '回答延遲過高', severity: 'warning', status: 'resolved', observed: '4.1 秒（門檻 4 秒）', startedAt: '昨天 15:07', durationLabel: '9 分鐘後恢復', notifiedCount: 3, notifyResult: '已寄出' },
]
