...
export const logEntries: LogEntry[] = [
	{ id: 'log-01', occurredAt: '2026-08-31T02:42:18.000Z', timestamp: '10:42:18', level: 'error', service: 'document-worker', message: '文件處理失敗：解析器逾時（資訊安全教育訓練.pdf）', traceId: 'trc-9f13a2', fields: { requestId: 'req-audit-001', documentId: 'doc-118', stage: 'parse', retries: '2' } },
	{ id: 'log-02', occurredAt: '2026-08-31T02:42:02.000Z', timestamp: '10:42:02', level: 'warn', service: 'llm-gateway', message: '推論請求逾時，改用備援模型重試', traceId: 'trc-9f1391', fields: { requestId: 'req-qa-6c5120', model: 'gpt-4.1-mini', timeoutMs: '8000', fallback: 'ollama-local' } },
	{ id: 'log-03', occurredAt: '2026-08-31T02:41:55.000Z', timestamp: '10:41:55', level: 'info', service: 'kmai-api', message: '問答完成：差旅住宿費用上限（2 筆引用）', traceId: 'trc-9f1386', fields: { requestId: 'req-qa-9f1386', userId: 'user-204', elapsedMs: '2410', citations: '2' } },
	...
	{ id: 'log-05', occurredAt: '2026-08-31T02:40:47.000Z', timestamp: '10:40:47', level: 'info', service: 'kmai-api', message: '登入成功：employee@company.com', traceId: 'trc-9f1360', fields: { requestId: 'req-auth-9f1360', ip: '10.20.1.18', method: 'password' } },
	...
	{ id: 'log-08', occurredAt: '2026-08-31T02:38:20.000Z', timestamp: '10:38:20', level: 'info', service: 'notification', message: '告警信已寄給 系統維運群組（3 位收件人）', traceId: 'trc-9f1329', fields: { requestId: 'req-audit-002', rule: '文件處理積壓過高', recipients: '3' } },
...
export const alertEvents: AlertEvent[] = [
	{ id: 'evt-01', occurredAt: '2026-08-31T02:30:00.000Z', ruleName: '文件處理積壓過高', severity: 'critical', status: 'firing', observed: '18 件（門檻 15 件）', startedAt: '今天 10:30', durationLabel: '持續 12 分鐘', delivery: { outcome: 'notified', matchedRuleNames: ['嚴重告警通知值班主管'], inAppRecipientCount: 2, emailRecipientCount: 1 } },
	{ id: 'evt-02', occurredAt: '2026-08-31T02:36:00.000Z', ruleName: '回答延遲過高', severity: 'warning', status: 'firing', observed: '4.3 秒（門檻 4 秒）', startedAt: '今天 10:36', durationLabel: '持續 6 分鐘', delivery: { outcome: 'notified', matchedRuleNames: ['警告與資訊告警通知維運'], inAppRecipientCount: 1, emailRecipientCount: 3 } },
	{ id: 'evt-03', occurredAt: '2026-08-31T01:58:00.000Z', ruleName: 'LLM 服務成功率下降', severity: 'warning', status: 'silenced', observed: '97.4%（門檻 98%）', startedAt: '今天 09:58', durationLabel: '靜音至 12:00', delivery: { outcome: 'silenced', matchedRuleNames: [], inAppRecipientCount: 0, emailRecipientCount: 0 } },
	{ id: 'evt-04', occurredAt: '2026-08-31T00:12:00.000Z', ruleName: '請求錯誤率異常', severity: 'critical', status: 'resolved', observed: '3.6%（門檻 3%）', startedAt: '今天 08:12', durationLabel: '22 分鐘後恢復', delivery: { outcome: 'notified', matchedRuleNames: ['嚴重告警通知值班主管'], inAppRecipientCount: 2, emailRecipientCount: 1 } },
	{ id: 'evt-05', occurredAt: '2026-08-30T14:41:00.000Z', ruleName: '文件處理積壓過高', severity: 'critical', status: 'resolved', observed: '16 件（門檻 15 件）', startedAt: '昨天 22:41', durationLabel: '35 分鐘後恢復', delivery: { outcome: 'notified', matchedRuleNames: ['嚴重告警通知值班主管'], inAppRecipientCount: 2, emailRecipientCount: 1 } },
	{ id: 'evt-06', occurredAt: '2026-08-30T07:07:00.000Z', ruleName: '回答延遲過高', severity: 'warning', status: 'resolved', observed: '4.1 秒（門檻 4 秒）', startedAt: '昨天 15:07', durationLabel: '9 分鐘後恢復', delivery: { outcome: 'notified', matchedRuleNames: ['警告與資訊告警通知維運'], inAppRecipientCount: 1, emailRecipientCount: 3 } },
]
