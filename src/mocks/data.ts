...
export const documents: KnowledgeDocument[] = [
	...
	},
	{
		...
		source: {
			type: 'file',
			fileName: '資訊安全教育訓練.pdf',
			mimeType: 'application/pdf',
			extension: 'pdf',
		},
		title: '資訊安全教育訓練教材',
		summary: '年度資安訓練教材，涵蓋釣魚郵件辨識、密碼管理與事件通報流程。',
		department: '資訊安全部',
		category: '資訊安全',
		subCategory: '事件通報',
		tags: ['教育訓練', '資安', '通報'],
	...
	},
	{
		...
		source: {
			type: 'file',
			fileName: '2026 產品規格彙整.xlsx',
			mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
			extension: 'xlsx',
		},
		title: '2026 產品規格彙整',
		summary: '彙整各產品線的規格、相容性與停售時程，供售前與客服查詢。',
		department: '客戶服務部',
		category: '產品與客戶',
		subCategory: '產品規格',
		tags: ['產品', '規格', '客服'],
	...
	},
	{
		...
		source: {
			type: 'file',
			fileName: '舊版辦公室門禁作業規範.pdf',
			mimeType: 'application/pdf',
			extension: 'pdf',
		},
		title: '辦公室門禁作業規範（2024 版）',
		summary: '2024 年門禁卡申請與訪客登記流程，已由總務新版規範取代。',
		department: '法務部',
		category: '公司制度',
		subCategory: '資產管理',
		tags: ['門禁', '訪客', '總務'],
...
// @ 首版文件（version 1.0）不應該憑空長出歷史版本，只保留目前這一版。
const previousVersionsByIndex: Record<number, Array<[string, string]>> = {
	0: [['3.1', '2026-02-03'], ['3.0', '2025-10-16']],
	1: [['1.5', '2025-12-18'], ['1.0', '2025-07-08']],
	2: [['4.0', '2026-04-22'], ['3.5', '2025-11-30']],
	3: [['1.7', '2026-03-14'], ['1.0', '2025-09-02']],
	4: [['2.2', '2026-01-10'], ['2.0', '2025-08-21']],
	7: [['2.3', '2025-06-05'], ['1.0', '2024-03-11']],
}
...
export const documentVersionHistoryById: Record<string, DocumentVersionEntry[]> = Object.fromEntries(
	documents.map((document, documentIndex) => [
		...
		[
			...
			...(previousVersionsByIndex[documentIndex] ?? []).map(([version, date], previousIndex) => ({
				version,
				date,
				author: document.owner,
				summary: previousIndex === 0
					? '依據使用回饋調整內容，讓操作步驟與規範更清楚。'
					: '建立文件基準版本，整理當時適用的流程與參考資料。',
				changes: previousIndex === 0
					? ['修正文句與名詞用法', '補充常見情境範例']
					: ['建立初始內容架構', '加入必要附件與參考來源'],
			})),
		],
	]),
)
