...
import KnowledgeSourceDialog from '@/components/KnowledgeSourceDialog.vue'
import ThinkingTrace from '@/components/ThinkingTrace.vue'
import { buildRunFromTrace, reportAnswerFeedback } from '@/repositories/feedback.repository'
...
<template>
	...
	<div class="ask-page" :class="{ 'is-empty': isEmptyState }">
		...
		<KnowledgeSourceDialog v-model="isScopeOpen" @closed="focusKnowledgeSourceTrigger" />
