...
<template>
  <main class="login-page">
    <section class="login-intro">
      <img :src="settingsState.brand.logoDataUrl ?? brandLogoUrl" :alt="settingsState.brand.systemName" class="login-logo mb-8" />
      <p class="eyebrow mb-3">{{ settingsState.brand.systemName }} {{ settingsState.brand.portalName }}</p>
